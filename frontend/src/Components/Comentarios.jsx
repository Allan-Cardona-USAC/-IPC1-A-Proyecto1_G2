...
function Comentarios() {
    ...
    const [selectedImage, setSelectedImage] = useState('https://sirse.info/wp-content/uploads/2015/05/cine541x311-800x500_c.jpg');
    ...
    const handleCambiarImagen = (event) => {
    ...
    const handleComentario = () => {
        ...
        fetch(`http://localhost:5000/comentarios`, {
            ...
            .then((res) => {
                ...
                setDescription("")
                setSelectedImage('https://sirse.info/wp-content/uploads/2015/05/cine541x311-800x500_c.jpg')
            })
            ...
            <div style={{ display: "flex", alignItems: "center", height: "90vh", width: "100%", top: "10", paddingBottom: "5%", paddingTop: "5%" }}>
                <div className="container-fluid h-100" style={{ marginRight: "20%", marginLeft: "20%", borderRadius: "25px", backgroundColor: "#D41212", display: "flex", padding: "5%", color: "white", flexDirection: "column" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", alignContent: "center", marginTop: "5%", flexDirection: "column" }}>
                        <label htmlFor="file-upload" className="btn btn-outline-light" style={{ fontSize: "19px", width: "100%", height: "auto", display: "flex", alignItems: "center", justifyContent: "center" }}>
                            ...
                            {"Escoja una imagen acerca de la película"}
                        </label>
                        <input onChange={handleCambiarImagen} id="file-upload" type="file" accept="image/*" style={{ display: "none" }} />
                    </div>
                    ...
                    <div style={{ width: "100%", marginTop: "5%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <button type="button" className="btn btn-outline-light" onClick={handleComentario}>
