    ...
    return (
        <Fragment>
            ...
            <div style={{ display: "flex", alignItems: "center", height: "90vh", width: "100%", top: "10" }}>
                <div className="table-containerL" >
                        ...
                        <tbody>
                            {users.map(user => (
                                <tr key={user.correo}>
                                    ...
                                    <td>
                                        <button className="btn btn-outline-danger" onClick={() => deleteUser(user.correo)} style={{ marginRight: "5%" }}>
                                            Eliminar
                                        </button>
                                        <button type="button" className="btn btn-outline-success"onClick={() => viewUser(user)}>Ver</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                    ...
                    {selectedUser && (
                        <Modal show={true} onHide={handleClose}>
                            ...
                            <Modal.Body>
                                ...
                                <p><strong>Fecha de Nacimiento:</strong> {selectedUser.nacimiento}</p>
                            </Modal.Body>
                            <Modal.Footer>
